...
class _ProfileScreenState extends State<ProfileScreen>
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    const Icon(Icons.phone, size: 16, color: Color(0xFF9C27B0)),
                    const SizedBox(width: 6),
                    Expanded(
                      child: Text(
                        _phone.isEmpty ? 'Add phone' : _phone,
            ...
            actions: [
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  await _updateUserField(fieldName.toLowerCase(), value);
                  onSave(value);
  ...
  Future<void> _updateUserField(String fieldKey, dynamic value) async {
    try {
      final uid = _auth.currentUser?.uid;
      if (uid == null) return;
      ...
      debugPrint('Failed updating $fieldKey: $e');
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Failed to update $fieldKey'),
